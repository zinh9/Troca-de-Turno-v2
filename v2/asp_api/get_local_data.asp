...
dim strUltimaAtt
strUltimaAtt = ultimaAtualizacao(qsSup)
...
"   Format(ra.data_hora_lanche_patio, 'hh:nn') AS horaLanche, " & _
"   Format(ra.data_hora_lanche_CPT, 'hh:nn') AS lancheCPT, " & _
"   ra.escolha_lanche_intervalo AS intervaloLanche, " & _
"   ra.justificativa_atraso_prontidao_lanche AS justificativaProntidaoLanche, " & _
"   Format(ra.prontidao_lanche, 'hh:nn') AS prontidaoLanche, " & _
"   ra.data_hora_refeicao_patio AS refeicao, " & _
"   Format(ra.data_hora_refeicao_patio, 'hh:nn') AS horaRefeicao, " & _
"   Format(ra.prontidao_refeicao, 'hh:nn') AS prontidaoRefeicao, " & _
"   Format(ra.data_hora_refeicao_CPT, 'hh:nn') AS refeicaoCPT, " & _
"   ra.justificativa_atraso_prontidao_refeicao AS justificativaProntidaoRefeicao, " & _
